...
class ColladaParser {
 public:
  ...
  static int load( const char* filename, SceneInfo* sceneInfo, double scale_factor);
 ...
 private:
  ...
  static void parse_node (XMLElement* xml, double scale_factor);
  ...
  static void parse_polymesh ( XMLElement* xml, PolymeshInfo& polymesh, double scale_factor);
