...
/**
 * Abstract renderer definition.public: renderer
 ...
 */
	...
	public:
		 ...
		 */
		virtual void cursor_event(float x, float y, bool reset) { }
		 ...
		 */
		virtual void mouse_key_event(int key, int event, unsigned char mods, bool update_key_only) { }
