...
int OSDText::init(bool use_hdpi) {
  ...
  /*  MSVC is limited to 65535 bytes ...*/
  string encoded = osdfont_base64_p1;
  encoded.append(osdfont_base64_p2);
  encoded.append(osdfont_base64_p3);
  encoded.append(osdfont_base64_p4);
  encoded.append(osdfont_base64_p5);
  encoded.append(osdfont_base64_p6);
